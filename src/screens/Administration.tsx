...
const ActionSheetView = ({ propPage, open, closeActionsheet }: { propPage: JSX.Element, open: boolean, closeActionsheet: () => void }) => {
    ...
    return (
        <ActionSheet ref={ref} sheetStyle={{ height: 100 + "%" }} onClose={() => closeActionsheet()}>
            {propPage}
        </ActionSheet>
    );
};
...
function CardBoss({
    ...
    return (
        <Card>
            ...
            <ActionSheetView propPage={children} open={open} closeActionsheet={closeActionsheet} />
        </Card>
    );
}
